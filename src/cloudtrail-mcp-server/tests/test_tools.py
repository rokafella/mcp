...
class TestCloudTrailToolsInitialization:
    ...
    def test_cloudtrail_client_property_caching(self, mock_get_client):
        """Test cloudtrail_client property caching behavior."""
        mock_client = Mock()
        ...
        # Should only call _get_cloudtrail_client once
